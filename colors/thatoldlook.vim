...
let s:red = '#e59606'
let s:yellow = '#d6b51f'
let s:green = '#a3b79a' " TODO: add a little better for light bg
...
call s:HL('IncSearch', s:hh, s:bg, s:inverse)
...
call s:HL('Search', s:hh, s:bg, s:inverse)
...
call s:HL('Label', s:scuba, s:none)
...
call s:HL('Error', s:red, s:bg, s:underline . s:inverse )
